...
# Title: Practica Conociendo USRP
# Author: DannyNavarro_SebastianRoman
# Copyright: UIS
...
class Practica1_labComu2_Grupo6(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Practica Conociendo USRP", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Practica Conociendo USRP")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica1_labComu2_Grupo6")
        ...
        # Blocks
        ##################################################
        self._N0_range = Range(1e-6, 500e-3, 1e-6, 250e-3, 200)
        self._N0_win = RangeWidget(self._N0_range, self.set_N0, "Amplitud Ruido", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._N0_win)
        ...
        self._Fc_range = Range(50e6, 2200e6, 1e6, 110e6, 200)
...
def main(top_block_cls=Practica1_labComu2_Grupo6, options=None):
